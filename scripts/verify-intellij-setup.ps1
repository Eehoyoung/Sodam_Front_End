...
try
{
    ...
    $checks = @(
        ...
        @{ Path = 'jest.config.cjs'; Desc = 'Jest config'; Mandatory = $true },
        @{ Path = 'jest.setup.js'; Desc = 'Jest setup'; Mandatory = $true },
        @{ Path = 'metro.config.cjs'; Desc = 'Metro config'; Mandatory = $true },
        @{ Path = 'react-native.config.cjs'; Desc = 'React Native config'; Mandatory = $true }
    )
    ...
    $jestPath = Join-Path $ProjectRoot 'jest.config.cjs'
