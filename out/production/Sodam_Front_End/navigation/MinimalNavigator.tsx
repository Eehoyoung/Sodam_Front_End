...
import { Platform, Pressable, SafeAreaView, StatusBar, Text, View, StyleSheet, Alert } from 'react-native';
      ...
      <GestureHandlerRootView style={{ flex: 1 }}>
        <NavigationContainer {...(linking ? { linking } : {})}>
          <Stack.Navigator screenOptions={screenOptions} initialRouteName={initialRouteName}>
            ...
            {stageAtLeast(18) && <Stack.Screen name="Home" getComponent={() => require('../features/home/screens/HomeScreen').default} />}
            {stageAtLeast(12) && (
