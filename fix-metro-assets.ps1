...
$metroConfigCjsExists = Test-Path "metro.config.cjs"
...
{
    Write-Host "  ✅ metro.config.cjs 발견됨 (CommonJS 모드)" -ForegroundColor Green
}
else
{
...
$configFiles = @("babel.config.js", "babel.config.cjs", "react-native.config.js", "react-native.config.cjs")
